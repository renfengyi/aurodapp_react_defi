        ...
        <div className='acontent'>
            ...
            <div className='content'>
                ...
                <div className='cbox'>
                    ...
                    <div className='cbox2'>
                        <Button type='primary' onClick={showModalC}>Lock</Button>
                    </div>
                </div>
                <div className='cbox'>
                    <div className='cbox1'>
            ...
            <div className='b_content'>
                <div className='b_content_box'>
                        ...
                        <div className='b_box_2line'>
                            ...
                            <div className='b_box_2line_c'>
                                ...
                                <div style={{margin:'10px'}}>
                                    <Button type='primary' onClick={showModalP}>Deposit</Button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className='b_box_3'>
                        <div className='b_box_3line' style={{fontSize:'18px',fontWeight:'bold'}}>Current Votes:3000</div>
